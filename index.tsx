  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans">
      <header className="p-6 flex justify-between items-center border-b border-gray-800">
        <h1 className="text-2xl font-serif text-yellow-400">AlphaVaultFX</h1>
        <nav className="space-x-4">
          <a href="/" className="hover:text-yellow-400">Home</a>
          <a href="/challenge" className="hover:text-yellow-400">Plans</a>
      ...
      <main className="p-10 text-center">
        ...
        <a href="/challenge" className="bg-yellow-400 text-black px-6 py-3 rounded hover:opacity-90">Start Your Challenge</a>
      </main>
    </div>
  );
}