    ...
    <div className="min-h-screen bg-black text-white px-6 py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {[
          ...
          <div
            key={plan.size}
            className="bg-gray-900 p-6 rounded-lg border border-gray-700 hover:border-gold"
          >
            ...
            <a
              href="/checkout"
              className="block text-center bg-gold text-black py-2 rounded hover:opacity-90"
            >
              Start Now
            </a>
          </div>
